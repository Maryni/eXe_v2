...
spusk=ceil(test);  
Edit2->Text=v;  Edit2->Text=Edit2->Text +" кг";               //Всего бумаги на тираж
...
lists=n*spusk;
Edit8->Text=lists;Edit8->Text=Edit8->Text + " листів"; //листы на тех
...
Edit11->Text=tech;Edit11->Text=Edit11->Text+" кг";
double onBlock=v+tech; onBlock=int(onBlock*100+0.5)/100;
Edit12->Text=onBlock;
CheckBox3->Checked=false;
if(Edit2->Text=="0 кг"){Label19->Visible=true;}
...
t5=t/K4; Edit15->Text=t5; Edit15->Text=Edit15->Text + " л";
...
priladka = K1*K; Edit16->Text=priladka;Edit16->Text=Edit16->Text + " л";
P1=((t5/100)*((K2+0.4)*5));Edit17->Text=P1;Edit17->Text=Edit17->Text + " л";
t4=ceil(P1+priladka);
Edit18->Text=t4;Edit18->Text=Edit18->Text + " л";


lak=ceil((t5/100)*K3);Edit19->Text=lak;Edit19->Text=Edit19->Text + " л";
T=t5+t4+lak;Edit20->Text=T;Edit20->Text=Edit20->Text+" л";
...
if(CheckListBox1->Checked[4]==true)
   { switch(ComboBox9->ItemIndex)
     ...
     Edit13->Text=kl;Edit13->Text=Edit13->Text+ " л";
     Edit21->Text=kk;Edit21->Text=Edit21->Text+ " кг";
     oth=SimpleRoundTo(oth/1000,-2);Edit22->Text=oth; Edit22->Text=Edit22->Text+" кг";
   }
// Пленка
...
//Цена
 ...
 switch (ComboBox9->ItemIndex)
     {                                                    //Обложка
         ...
         v_1=vbez*1.2;                                       //за 1 шт
         cost1=v_1/t; cost1=SimpleRoundTo(cost1,-2);
        Edit24->Text=cost1; Edit24->Text=Edit24->Text+" грн";

        

        paper_o=StrToFloat(Edit25->Text);
        paper_o=paper_o/1000;
        T_f0=T;   //листов на тираж + тех нужды + лакировка/плёнка
        T_f1=T_f0*g1*g2*paper_o;
        T_f1=SimpleRoundTo(T_f1,-2);
        Edit31->Text=T_f1; Edit31->Text=Edit31->Text+" л";
